...
export default function Home() {
    return (
        <main className="flex flex-col min-h-screen px-24 pb-24 bg-[#19151E] z-20 justify-center">
            <div className="flex flex-row fixed top-0 h-24 w-11/12 z-20 bg-[#19151E] items-end">
